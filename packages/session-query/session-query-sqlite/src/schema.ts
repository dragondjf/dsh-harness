 ...
 */
export async function openSearchDatabase(path: string, journalMode: JournalMode): Promise<Database.Database> {
...
function resetDerivedSchema(db: Database.Database, userTables: readonly string[]): void {
...
function ensurePersistentSchema(db: Database.Database): void {
...
function ensureTemporarySchema(db: Database.Database): void {
  db.exec(`
