window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-goal/src/client/GoalBar.module.css.mjs
		const css$1 = ".tw8RsW_dock{box-sizing:border-box;width:calc(100% - var(--dsh-composer-side-clearance) - var(--dsh-composer-side-clearance) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset));margin:0 auto}.tw8RsW_bar{box-sizing:border-box;width:100%;max-width:calc(var(--dsh-composer-card-max-width) - 4 * var(--dsh-composer-dock-inset));border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-specific-tip);border-radius:12px;align-items:center;gap:10px;height:36px;margin:0 auto;padding:4px 5px 4px 12px;display:flex}.tw8RsW_goalGlyph{color:var(--dsw-alias-label-tertiary);flex:none;display:inline-flex}.tw8RsW_label{color:var(--dsw-alias-label-primary);flex:none;font-size:13px;font-weight:500;line-height:24px}.tw8RsW_objective{min-width:0;color:var(--dsw-alias-label-primary-dimmed);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}.tw8RsW_error{min-width:0;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:20px;overflow:hidden}.tw8RsW_objectiveInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-primary);border-radius:6px;outline:none;flex:1;padding:0 8px;font-size:13px;line-height:20px}.tw8RsW_objectiveInput:focus{border-color:var(--dsw-alias-state-business-primary)}.tw8RsW_objectiveInput::placeholder{color:var(--dsw-alias-label-caption)}.tw8RsW_actions{flex:none;align-items:center;gap:10px;display:flex}.tw8RsW_iconBtn{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.tw8RsW_iconBtn:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.tw8RsW_iconBtn:disabled{opacity:.4;cursor:default}";
		...
		var GoalBar_module_css_default = {
			"objectiveInput": "tw8RsW_objectiveInput",
			"goalGlyph": "tw8RsW_goalGlyph",
			"error": "tw8RsW_error",
			"label": "tw8RsW_label",
			"iconBtn": "tw8RsW_iconBtn",
			"objective": "tw8RsW_objective",
			"bar": "tw8RsW_bar",
			"dock": "tw8RsW_dock",
			"actions": "tw8RsW_actions"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-goal/src/client/GoalCommandInputView.module.css.mjs
		const css = "._5R6GJq_row{flex-direction:column;align-items:flex-end;gap:6px;display:flex}._5R6GJq_stack{flex-direction:column;align-items:flex-end;min-width:0;max-width:min(525px,82%);display:flex}._5R6GJq_bubble{overflow-wrap:anywhere;background:var(--dsw-specific-bubble);max-width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code);white-space:pre-wrap;border-radius:22px;padding:10px 16px}";
