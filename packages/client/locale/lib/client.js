window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/locale/src/client/LanguageRow.module.css.mjs
		const css = ".vkUXTG_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.vkUXTG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.vkUXTG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.vkUXTG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.vkUXTG_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.vkUXTG_chevron{flex:none}";
		...
		var LanguageRow_module_css_default = {
			"selector": "vkUXTG_selector",
			"chevron": "vkUXTG_chevron",
			"row": "vkUXTG_row",
			"title": "vkUXTG_title",
			"rowText": "vkUXTG_rowText"
		};
		//#endregion
