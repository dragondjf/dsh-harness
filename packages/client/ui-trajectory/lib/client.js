window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryTable.module.css.mjs
		const css$3 = ".Z9b6Xq_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.Z9b6Xq_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:Z9b6Xq_trajectory-table/inline-size}.Z9b6Xq_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.Z9b6Xq_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.Z9b6Xq_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite Z9b6Xq_history-loading-spin}.Z9b6Xq_table tbody .Z9b6Xq_historyLoadRow td{height:30px;padding:0}.Z9b6Xq_table tbody .Z9b6Xq_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.Z9b6Xq_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.Z9b6Xq_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.Z9b6Xq_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.Z9b6Xq_historyLoadButton:disabled{cursor:default}.Z9b6Xq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.Z9b6Xq_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes Z9b6Xq_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.Z9b6Xq_historyLoadingSpinner{animation:none}}.Z9b6Xq_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.Z9b6Xq_eventColumn{width:122px}.Z9b6Xq_contentColumn{width:auto}.Z9b6Xq_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.Z9b6Xq_eventHeader{text-align:right!important;padding-right:4px!important}.Z9b6Xq_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.Z9b6Xq_table tbody .Z9b6Xq_virtualSpacer{pointer-events:none}.Z9b6Xq_table tbody .Z9b6Xq_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.Z9b6Xq_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.Z9b6Xq_table tbody tr[data-timeline-focus=outside]{opacity:.24}.Z9b6Xq_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.Z9b6Xq_table tbody tr[data-request-only=true]:hover{background:0 0}.Z9b6Xq_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.Z9b6Xq_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.Z9b6Xq_table tbody tr[data-request-only=true] .Z9b6Xq_turnRail{top:-15px;bottom:0}.Z9b6Xq_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.Z9b6Xq_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.Z9b6Xq_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.Z9b6Xq_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.Z9b6Xq_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.Z9b6Xq_requestBoundaryControl:hover:before,.Z9b6Xq_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.Z9b6Xq_requestBoundaryControlActive:before,.Z9b6Xq_requestBoundaryControlActive:hover:before,.Z9b6Xq_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.Z9b6Xq_requestBoundaryControl[data-request-status=error]:before,.Z9b6Xq_requestBoundaryControl[data-request-status=error]:hover:before,.Z9b6Xq_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.Z9b6Xq_requestBoundaryControl:hover:after,.Z9b6Xq_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.Z9b6Xq_requestBoundaryControl:focus-visible{outline:none}.Z9b6Xq_table tbody tr:has(.Z9b6Xq_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.Z9b6Xq_event{position:relative}.Z9b6Xq_turnRail,.Z9b6Xq_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.Z9b6Xq_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.Z9b6Xq_table tbody tr[data-turn-end=true] .Z9b6Xq_turnRail{bottom:0}.Z9b6Xq_selectionRail{z-index:5;width:3px;top:0;bottom:0}.Z9b6Xq_table tbody tr[data-error=true] .Z9b6Xq_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.Z9b6Xq_table tbody tr[data-error=true] .Z9b6Xq_selectionRail{background:var(--dsw-alias-state-error-primary)}.Z9b6Xq_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.Z9b6Xq_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.Z9b6Xq_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.Z9b6Xq_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.Z9b6Xq_turnLabelFull,.Z9b6Xq_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.Z9b6Xq_turnLabelCompact{opacity:0;max-width:0}.Z9b6Xq_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.Z9b6Xq_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.Z9b6Xq_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.Z9b6Xq_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.Z9b6Xq_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.Z9b6Xq_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.Z9b6Xq_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.Z9b6Xq_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.Z9b6Xq_table .Z9b6Xq_kindSlot .Z9b6Xq_message{justify-content:center;width:100%}@container Z9b6Xq_trajectory-table (width<=620px){.Z9b6Xq_eventColumn{width:50px}.Z9b6Xq_event{padding-left:28px!important;padding-right:3px!important}.Z9b6Xq_requestBoundaryControl{--request-boundary-base-left:6px}.Z9b6Xq_kindSlot{width:19px}.Z9b6Xq_kindTag,.Z9b6Xq_table .Z9b6Xq_kindSlot .Z9b6Xq_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.Z9b6Xq_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.Z9b6Xq_kindTagLabel,.Z9b6Xq_turnLabelFull{opacity:0;max-width:0}.Z9b6Xq_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.Z9b6Xq_eventColumn,.Z9b6Xq_event,.Z9b6Xq_requestBoundaryControl,.Z9b6Xq_kindSlot,.Z9b6Xq_kindTag,.Z9b6Xq_kindTagIcon,.Z9b6Xq_kindTagLabel,.Z9b6Xq_turnLabelFull,.Z9b6Xq_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.Z9b6Xq_eventColumn,.Z9b6Xq_kindSlot{transition-property:width}.Z9b6Xq_event{transition-property:padding-right,padding-left}.Z9b6Xq_requestBoundaryControl{transition-property:left}.Z9b6Xq_kindTag{transition-property:padding-right,padding-left}.Z9b6Xq_kindTagIcon{transition-property:width,opacity,transform}.Z9b6Xq_kindTagLabel,.Z9b6Xq_turnLabelFull,.Z9b6Xq_turnLabelCompact{transition-property:max-width,opacity}}.Z9b6Xq_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.Z9b6Xq_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.Z9b6Xq_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.Z9b6Xq_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.Z9b6Xq_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.Z9b6Xq_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.Z9b6Xq_promptDiffSection{min-width:0}.Z9b6Xq_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.Z9b6Xq_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.Z9b6Xq_promptDiff span{min-width:max-content;padding:0 6px;display:block}.Z9b6Xq_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.Z9b6Xq_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.Z9b6Xq_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.Z9b6Xq_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.Z9b6Xq_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.Z9b6Xq_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.Z9b6Xq_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.Z9b6Xq_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.Z9b6Xq_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.Z9b6Xq_table tbody tr[data-collapsed-summary=turn] td,.Z9b6Xq_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.Z9b6Xq_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.Z9b6Xq_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.Z9b6Xq_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.Z9b6Xq_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.Z9b6Xq_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.Z9b6Xq_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Z9b6Xq_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.Z9b6Xq_resultRequest,.Z9b6Xq_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Z9b6Xq_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.Z9b6Xq_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.Z9b6Xq_table tbody tr[data-kind=tool] .Z9b6Xq_contentText,.Z9b6Xq_table tbody tr[data-kind=subtool] .Z9b6Xq_contentText,.Z9b6Xq_table tbody tr[data-kind=tool] .Z9b6Xq_resultPreview,.Z9b6Xq_table tbody tr[data-kind=subtool] .Z9b6Xq_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.Z9b6Xq_table tbody tr[data-kind=subtool] .Z9b6Xq_content{padding-left:26px}.Z9b6Xq_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.Z9b6Xq_noOutputText{color:var(--dsw-alias-label-caption)}.Z9b6Xq_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.Z9b6Xq_error,.Z9b6Xq_overview dd.Z9b6Xq_error,.Z9b6Xq_details .Z9b6Xq_errorPayload{color:var(--dsw-alias-state-error-primary)}.Z9b6Xq_details .Z9b6Xq_errorPayload .Z9b6Xq_resultBlockText{color:inherit}.Z9b6Xq_details .Z9b6Xq_jsonPayload.Z9b6Xq_errorPayload,.Z9b6Xq_details .Z9b6Xq_jsonPreview.Z9b6Xq_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.Z9b6Xq_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.Z9b6Xq_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.Z9b6Xq_detailsResizeHandle:focus-visible{outline:none}.Z9b6Xq_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.Z9b6Xq_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.Z9b6Xq_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.Z9b6Xq_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.Z9b6Xq_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Z9b6Xq_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.Z9b6Xq_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Z9b6Xq_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.Z9b6Xq_detailTabs::-webkit-scrollbar{display:none}.Z9b6Xq_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.Z9b6Xq_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.Z9b6Xq_detailTabActive{color:var(--dsw-alias-state-business-primary)}.Z9b6Xq_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.Z9b6Xq_close:focus-visible,.Z9b6Xq_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Z9b6Xq_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.Z9b6Xq_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.Z9b6Xq_detailBodySummary>.Z9b6Xq_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.Z9b6Xq_detailBodySummary>.Z9b6Xq_compactedSummary{flex:1;min-height:0;overflow:auto}.Z9b6Xq_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.Z9b6Xq_summaryScrollRegion:hover,.Z9b6Xq_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.Z9b6Xq_compactedSummary .Z9b6Xq_markdownPayload{padding-right:18px}.Z9b6Xq_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.Z9b6Xq_overviewParentLinks{gap:14px;display:flex}.Z9b6Xq_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.Z9b6Xq_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.Z9b6Xq_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.Z9b6Xq_overviewHierarchyNavLink:hover .Z9b6Xq_overviewHierarchyJumpIconTight,.Z9b6Xq_overviewHierarchyNavLink:focus-visible .Z9b6Xq_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.Z9b6Xq_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Z9b6Xq_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.Z9b6Xq_overview>.Z9b6Xq_requestTokenDetail dt{padding-left:12px}.Z9b6Xq_usagePanel{padding:4px 0 10px}.Z9b6Xq_usageGroup+.Z9b6Xq_usageGroup{margin-top:8px}.Z9b6Xq_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.Z9b6Xq_usageGroup .Z9b6Xq_overview{padding:0}.Z9b6Xq_overview dt{color:var(--dsw-alias-label-tertiary)}.Z9b6Xq_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.Z9b6Xq_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.Z9b6Xq_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Z9b6Xq_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.Z9b6Xq_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.Z9b6Xq_overviewSection+.Z9b6Xq_overviewSection{padding-top:8px}.Z9b6Xq_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.Z9b6Xq_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.Z9b6Xq_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.Z9b6Xq_overviewTitle:hover .Z9b6Xq_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.Z9b6Xq_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Z9b6Xq_overviewTitle:focus-visible .Z9b6Xq_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.Z9b6Xq_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.Z9b6Xq_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.Z9b6Xq_overviewPreview .Z9b6Xq_jsonPreview>:first-child,.Z9b6Xq_overviewPreview .Z9b6Xq_schemaTree>:first-child{padding-bottom:0}.Z9b6Xq_overviewPreview .Z9b6Xq_schemaTree{margin-bottom:0}.Z9b6Xq_overviewPreview .Z9b6Xq_overview{padding:2px 0 0}.Z9b6Xq_overviewPreview .Z9b6Xq_overview>div{min-height:22px}.Z9b6Xq_markdownPreview,.Z9b6Xq_markdownPayload{color:var(--dsw-alias-label-primary)}.Z9b6Xq_markdownPreview>div,.Z9b6Xq_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.Z9b6Xq_markdownPreview>div h1,.Z9b6Xq_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.Z9b6Xq_markdownPreview>div h2,.Z9b6Xq_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.Z9b6Xq_markdownPreview>div :where(h3,h4,h5,h6),.Z9b6Xq_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.Z9b6Xq_markdownPreview>div :not(pre)>code,.Z9b6Xq_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.Z9b6Xq_markdownPreview>div table,.Z9b6Xq_markdownPayload>div table{font:var(--dsw-font-xs-13)}.Z9b6Xq_markdownPreview>div>:first-child{margin-top:0}.Z9b6Xq_markdownPreview>div>:last-child{margin-bottom:0}.Z9b6Xq_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.Z9b6Xq_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.Z9b6Xq_markdownPreview>div :where(p,ul,ol){margin:8px 0}.Z9b6Xq_markdownPreview>div li:not(:first-child){margin-top:3px}.Z9b6Xq_markdownPreview>div blockquote{margin-top:8px}.Z9b6Xq_markdownPreview>div hr{margin:14px 0}.Z9b6Xq_markdownPreview>div>.md-code-block{margin:10px 0}.Z9b6Xq_assistantContent .Z9b6Xq_markdownPayload,.Z9b6Xq_assistantContent .Z9b6Xq_payload{min-height:0}.Z9b6Xq_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.Z9b6Xq_thinkingQuoteOnlyPreview{margin-bottom:8px}.Z9b6Xq_detailBody>.Z9b6Xq_assistantContentRendered .Z9b6Xq_thinkingQuote{margin-top:14px}.Z9b6Xq_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.Z9b6Xq_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.Z9b6Xq_thinkingToggle[aria-expanded=true] .Z9b6Xq_thinkingChevron{transform:rotate(90deg)}.Z9b6Xq_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.Z9b6Xq_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.Z9b6Xq_thinkingQuote .Z9b6Xq_markdownPreview,.Z9b6Xq_thinkingQuote .Z9b6Xq_markdownPayload,.Z9b6Xq_thinkingQuote .Z9b6Xq_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.Z9b6Xq_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.Z9b6Xq_markdownPreview{padding:6px 14px 8px}.Z9b6Xq_markdownPayload{min-height:100%;padding:14px}.Z9b6Xq_jsonPayload{min-height:100%}.Z9b6Xq_jsonPreview{min-height:0}.Z9b6Xq_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.Z9b6Xq_schemaPreview{min-height:0}.Z9b6Xq_schemaIntro{padding:12px 14px 6px}.Z9b6Xq_schemaPreview .Z9b6Xq_schemaIntro{padding-top:6px}.Z9b6Xq_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.Z9b6Xq_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.Z9b6Xq_schemaParameters{min-width:0}.Z9b6Xq_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.Z9b6Xq_schemaTree{margin:0 6px 8px 0}.Z9b6Xq_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.Z9b6Xq_payloadPreview{min-height:0;padding:6px 14px 8px}.Z9b6Xq_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.Z9b6Xq_sourceBlock+.Z9b6Xq_sourceBlock{margin-top:14px}.Z9b6Xq_sourceBlockHeader,.Z9b6Xq_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.Z9b6Xq_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.Z9b6Xq_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.Z9b6Xq_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.Z9b6Xq_sourceBlockJumpTarget:hover .Z9b6Xq_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.Z9b6Xq_sourceBlockJumpTarget:focus-visible{outline:none}.Z9b6Xq_sourceBlockJumpTarget:focus-visible .Z9b6Xq_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.Z9b6Xq_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.Z9b6Xq_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.Z9b6Xq_panelImageLinkPreview{max-height:140px}.Z9b6Xq_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.Z9b6Xq_panelImageLinkPreview .Z9b6Xq_panelImage{max-height:140px}.Z9b6Xq_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.Z9b6Xq_messageImagesPreview{gap:6px;margin:6px 14px 8px}.Z9b6Xq_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.Z9b6Xq_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.Z9b6Xq_assistantToolCalls li{min-width:0}.Z9b6Xq_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.Z9b6Xq_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Z9b6Xq_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Z9b6Xq_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.Z9b6Xq_assistantToolCallButton:hover .Z9b6Xq_assistantToolCallIcon,.Z9b6Xq_assistantToolCallButton:focus-visible .Z9b6Xq_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.Z9b6Xq_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.Z9b6Xq_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.Z9b6Xq_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Z9b6Xq_systemPrompt{box-sizing:border-box}.Z9b6Xq_toolCatalog{min-height:100%;padding:8px 0 16px}.Z9b6Xq_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.Z9b6Xq_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.Z9b6Xq_toolCatalogSummary::-webkit-details-marker{display:none}.Z9b6Xq_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.Z9b6Xq_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Z9b6Xq_toolCatalogChevron,.Z9b6Xq_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.Z9b6Xq_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.Z9b6Xq_toolCatalogItem[open] .Z9b6Xq_toolCatalogChevron{transform:rotate(90deg)}.Z9b6Xq_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.Z9b6Xq_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.Z9b6Xq_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.Z9b6Xq_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.Z9b6Xq_toolCatalogTree{margin-left:-14px;margin-right:6px}.Z9b6Xq_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.Z9b6Xq_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.Z9b6Xq_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.Z9b6Xq_overviewPreview .Z9b6Xq_noPayload{padding:6px 14px 8px}.Z9b6Xq_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.Z9b6Xq_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"kindSlot": "Z9b6Xq_kindSlot",
			"eventInner": "Z9b6Xq_eventInner",
			"assistantToolCallsPreview": "Z9b6Xq_assistantToolCallsPreview",
			"historyLoading": "Z9b6Xq_historyLoading",
			"eventColumn": "Z9b6Xq_eventColumn",
			"contentColumn": "Z9b6Xq_contentColumn",
			"thinkingQuoteOnlyPreview": "Z9b6Xq_thinkingQuoteOnlyPreview",
			"assistantToolCallText": "Z9b6Xq_assistantToolCallText",
			"toolCatalogChevron": "Z9b6Xq_toolCatalogChevron",
			"resultBlocks": "Z9b6Xq_resultBlocks",
			"panelImageLinkPreview": "Z9b6Xq_panelImageLinkPreview",
			"promptDiffLinecontext": "Z9b6Xq_promptDiffLinecontext",
			"sourceBlockHeader": "Z9b6Xq_sourceBlockHeader",
			"payloadPreview": "Z9b6Xq_payloadPreview",
			"schemaParameters": "Z9b6Xq_schemaParameters",
			"toolAmber": "Z9b6Xq_toolAmber",
			"usagePanel": "Z9b6Xq_usagePanel",
			"promptDiffTitle": "Z9b6Xq_promptDiffTitle",
			"inlineResultText": "Z9b6Xq_inlineResultText",
			"toolCatalogDefinition": "Z9b6Xq_toolCatalogDefinition",
			"requestBoundaryControl": "Z9b6Xq_requestBoundaryControl",
			"compactedSummary": "Z9b6Xq_compactedSummary",
			"turnLabelActive": "Z9b6Xq_turnLabelActive",
			"user": "Z9b6Xq_user",
			"requestTokenDetail": "Z9b6Xq_requestTokenDetail",
			"assistantToolCallName": "Z9b6Xq_assistantToolCallName",
			"panelImage": "Z9b6Xq_panelImage",
			"systemPrompt": "Z9b6Xq_systemPrompt",
			"schemaName": "Z9b6Xq_schemaName",
			"promptDiffLineadded": "Z9b6Xq_promptDiffLineadded",
			"toolCatalog": "Z9b6Xq_toolCatalog",
			"overviewTitleIcon": "Z9b6Xq_overviewTitleIcon",
			"historyLoadRow": "Z9b6Xq_historyLoadRow",
			"close": "Z9b6Xq_close",
			"thinkingToggle": "Z9b6Xq_thinkingToggle",
			"assistantOutput": "Z9b6Xq_assistantOutput",
			"panelImageLink": "Z9b6Xq_panelImageLink",
			"assistantToolCallButton": "Z9b6Xq_assistantToolCallButton",
			"history-loading-spin": "Z9b6Xq_history-loading-spin",
			"overview": "Z9b6Xq_overview",
			"toolCatalogTree": "Z9b6Xq_toolCatalogTree",
			"schemaIntro": "Z9b6Xq_schemaIntro",
			"overviewPreview": "Z9b6Xq_overviewPreview",
			"contextGreen": "Z9b6Xq_contextGreen",
			"usageHeading": "Z9b6Xq_usageHeading",
			"details": "Z9b6Xq_details",
			"turnLabelFull": "Z9b6Xq_turnLabelFull",
			"messageImages": "Z9b6Xq_messageImages",
			"assistantToolCallIcon": "Z9b6Xq_assistantToolCallIcon",
			"overviewParentLinks": "Z9b6Xq_overviewParentLinks",
			"assistantVioletBright": "Z9b6Xq_assistantVioletBright",
			"error": "Z9b6Xq_error",
			"toolCatalogItem": "Z9b6Xq_toolCatalogItem",
			"detailBody": "Z9b6Xq_detailBody",
			"detailBodySummary": "Z9b6Xq_detailBodySummary",
			"jsonPreview": "Z9b6Xq_jsonPreview",
			"messageImagesPreview": "Z9b6Xq_messageImagesPreview",
			"detailsHeader": "Z9b6Xq_detailsHeader",
			"overviewTitle": "Z9b6Xq_overviewTitle",
			"turnRail": "Z9b6Xq_turnRail",
			"historyLoadingBar": "Z9b6Xq_historyLoadingBar",
			"event": "Z9b6Xq_event",
			"toolCallNameTypeface": "Z9b6Xq_toolCallNameTypeface",
			"jsonPayload": "Z9b6Xq_jsonPayload",
			"schema": "Z9b6Xq_schema",
			"table": "Z9b6Xq_table",
			"collapsedTurnText": "Z9b6Xq_collapsedTurnText",
			"requestDetailsDot": "Z9b6Xq_requestDetailsDot",
			"sourceBlockJumpTarget": "Z9b6Xq_sourceBlockJumpTarget",
			"overviewSection": "Z9b6Xq_overviewSection",
			"assistantToolCallArgs": "Z9b6Xq_assistantToolCallArgs",
			"noPayload": "Z9b6Xq_noPayload",
			"systemNeutral": "Z9b6Xq_systemNeutral",
			"subtoolAmber": "Z9b6Xq_subtoolAmber",
			"visuallyHidden": "Z9b6Xq_visuallyHidden",
			"compacted": "Z9b6Xq_compacted",
			"overviewHierarchyNavLink": "Z9b6Xq_overviewHierarchyNavLink",
			"usageGroup": "Z9b6Xq_usageGroup",
			"requestDetailsName": "Z9b6Xq_requestDetailsName",
			"collapsedTurnContent": "Z9b6Xq_collapsedTurnContent",
			"sourceBlocks": "Z9b6Xq_sourceBlocks",
			"sourceBlock": "Z9b6Xq_sourceBlock",
			"historyLoadingSpinner": "Z9b6Xq_historyLoadingSpinner",
			"overviewSections": "Z9b6Xq_overviewSections",
			"schemaTree": "Z9b6Xq_schemaTree",
			"timestampToggle": "Z9b6Xq_timestampToggle",
			"sourceBlockJumpIcon": "Z9b6Xq_sourceBlockJumpIcon",
			"tablePane": "Z9b6Xq_tablePane",
			"split": "Z9b6Xq_split",
			"promptDiffSection": "Z9b6Xq_promptDiffSection",
			"inlineResult": "Z9b6Xq_inlineResult",
			"markdownPreview": "Z9b6Xq_markdownPreview",
			"promptDiffSections": "Z9b6Xq_promptDiffSections",
			"detailTabActive": "Z9b6Xq_detailTabActive",
			"promptDiff": "Z9b6Xq_promptDiff",
			"turnLabel": "Z9b6Xq_turnLabel",
			"promptDiffLineremoved": "Z9b6Xq_promptDiffLineremoved",
			"turnLabelCompact": "Z9b6Xq_turnLabelCompact",
			"overviewHeading": "Z9b6Xq_overviewHeading",
			"overviewHierarchyJumpIconTight": "Z9b6Xq_overviewHierarchyJumpIconTight",
			"payload": "Z9b6Xq_payload",
			"detailsLocation": "Z9b6Xq_detailsLocation",
			"noOutputText": "Z9b6Xq_noOutputText",
			"toolCatalogName": "Z9b6Xq_toolCatalogName",
			"content": "Z9b6Xq_content",
			"virtualSpacer": "Z9b6Xq_virtualSpacer",
			"trajectory-table": "Z9b6Xq_trajectory-table",
			"kindTagLabel": "Z9b6Xq_kindTagLabel",
			"toolCatalogIcon": "Z9b6Xq_toolCatalogIcon",
			"historyLoadButton": "Z9b6Xq_historyLoadButton",
			"kindTag": "Z9b6Xq_kindTag",
			"detailsResizeHandle": "Z9b6Xq_detailsResizeHandle",
			"assistantToolCalls": "Z9b6Xq_assistantToolCalls",
			"toolCatalogSummary": "Z9b6Xq_toolCatalogSummary",
			"schemaDescription": "Z9b6Xq_schemaDescription",
			"resultPreview": "Z9b6Xq_resultPreview",
			"sourceBlockLabel": "Z9b6Xq_sourceBlockLabel",
			"kindTagIcon": "Z9b6Xq_kindTagIcon",
			"errorPayload": "Z9b6Xq_errorPayload",
			"assistantContentRendered": "Z9b6Xq_assistantContentRendered",
			"toolCatalogFullDescription": "Z9b6Xq_toolCatalogFullDescription",
			"resultRequest": "Z9b6Xq_resultRequest",
			"detailTab": "Z9b6Xq_detailTab",
			"requestBoundaryControlActive": "Z9b6Xq_requestBoundaryControlActive",
			"summaryScrollRegion": "Z9b6Xq_summaryScrollRegion",
			"thinkingQuote": "Z9b6Xq_thinkingQuote",
			"resultBlocksPreview": "Z9b6Xq_resultBlocksPreview",
			"toolCallOnly": "Z9b6Xq_toolCallOnly",
			"arrow": "Z9b6Xq_arrow",
			"resultBlockText": "Z9b6Xq_resultBlockText",
			"assistantContent": "Z9b6Xq_assistantContent",
			"eventHeader": "Z9b6Xq_eventHeader",
			"detailsTitle": "Z9b6Xq_detailsTitle",
			"schemaParametersTitle": "Z9b6Xq_schemaParametersTitle",
			"markdownPayload": "Z9b6Xq_markdownPayload",
			"promptDiffLinemeta": "Z9b6Xq_promptDiffLinemeta",
			"message": "Z9b6Xq_message",
			"thinkingChevron": "Z9b6Xq_thinkingChevron",
			"schemaPreview": "Z9b6Xq_schemaPreview",
			"selectionRail": "Z9b6Xq_selectionRail",
			"sourceBlockContent": "Z9b6Xq_sourceBlockContent",
			"toolCatalogDescription": "Z9b6Xq_toolCatalogDescription",
			"collapsedTurnEllipsis": "Z9b6Xq_collapsedTurnEllipsis",
			"contentText": "Z9b6Xq_contentText",
			"toolCallPayload": "Z9b6Xq_toolCallPayload",
			"detailTabs": "Z9b6Xq_detailTabs"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryToolbar.module.css.mjs
		const css$2 = ".ovMAOW_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.ovMAOW_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.ovMAOW_actions{flex:none;align-items:center;gap:2px;display:flex}.ovMAOW_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.ovMAOW_toggle:hover,.ovMAOW_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.ovMAOW_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.ovMAOW_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.ovMAOW_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.ovMAOW_control[hidden]{display:none}.ovMAOW_control:hover:not(:disabled),.ovMAOW_control[aria-checked=true],.ovMAOW_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.ovMAOW_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.ovMAOW_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.ovMAOW_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.ovMAOW_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.ovMAOW_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.ovMAOW_controlTrack[data-on=true] .ovMAOW_controlThumb{transform:translate(10px)}.ovMAOW_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.ovMAOW_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.ovMAOW_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.ovMAOW_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.ovMAOW_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.ovMAOW_search:hover{border-color:var(--dsw-alias-label-caption)}.ovMAOW_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.ovMAOW_searchIcon{flex:none}.ovMAOW_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.ovMAOW_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.ovMAOW_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"searchInput": "ovMAOW_searchInput",
			"actionIcon": "ovMAOW_actionIcon",
			"search": "ovMAOW_search",
			"toggle": "ovMAOW_toggle",
			"actions": "ovMAOW_actions",
			"control": "ovMAOW_control",
			"toggleIcon": "ovMAOW_toggleIcon",
			"controlThumb": "ovMAOW_controlThumb",
			"inner": "ovMAOW_inner",
			"root": "ovMAOW_root",
			"controlTrack": "ovMAOW_controlTrack",
			"action": "ovMAOW_action",
			"searchIcon": "ovMAOW_searchIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryTimeline.module.css.mjs
		const css$1 = ".e3Aw-a_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.e3Aw-a_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.e3Aw-a_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.e3Aw-a_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.e3Aw-a_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.e3Aw-a_labels span:first-child{top:7px}.e3Aw-a_labels span:nth-child(2){top:21px}.e3Aw-a_labels span:nth-child(3){top:35px}.e3Aw-a_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.e3Aw-a_track[data-panning=true]{cursor:grabbing}.e3Aw-a_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.e3Aw-a_earlierHistory:hover{opacity:1}.e3Aw-a_earlierHistory[aria-disabled=true]{cursor:default}.e3Aw-a_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.e3Aw-a_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.e3Aw-a_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.e3Aw-a_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.e3Aw-a_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.e3Aw-a_lanes[data-animate-viewport=true],.e3Aw-a_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.e3Aw-a_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.e3Aw-a_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.e3Aw-a_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.e3Aw-a_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.e3Aw-a_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.e3Aw-a_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.e3Aw-a_span[data-timeline-span=tool],.e3Aw-a_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.e3Aw-a_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.e3Aw-a_span[data-equal-duration=true]{width:8px;min-width:8px}.e3Aw-a_span[data-selected=false]{opacity:.2}.e3Aw-a_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.e3Aw-a_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.e3Aw-a_span[data-search-match=false]{opacity:.14}.e3Aw-a_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.e3Aw-a_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.e3Aw-a_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.e3Aw-a_selectionEdges:before,.e3Aw-a_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.e3Aw-a_selectionEdges:before{left:0}.e3Aw-a_selectionEdges:after{right:0}.e3Aw-a_selectionEdges[data-dragging=true]:before,.e3Aw-a_selectionEdges[data-dragging=true]:after{width:2px}.e3Aw-a_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"hoverLine": "e3Aw-a_hoverLine",
			"root": "e3Aw-a_root",
			"plot": "e3Aw-a_plot",
			"labels": "e3Aw-a_labels",
			"turnBoundaries": "e3Aw-a_turnBoundaries",
			"lanes": "e3Aw-a_lanes",
			"track": "e3Aw-a_track",
			"empty": "e3Aw-a_empty",
			"earlierHistory": "e3Aw-a_earlierHistory",
			"selection": "e3Aw-a_selection",
			"selectionEdges": "e3Aw-a_selectionEdges",
			"turnBoundary": "e3Aw-a_turnBoundary",
			"span": "e3Aw-a_span"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-trajectory/src/client/views.module.css.mjs
		const css = ".H1XbPa_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.H1XbPa_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
