window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-subagent/src/client/SubagentCatalogAction.module.css.mjs
		const css$1 = ".GPyqUG_root{position:relative}.GPyqUG_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.GPyqUG_count{margin:0 5px}.GPyqUG_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.GPyqUG_trigger:hover,.GPyqUG_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.GPyqUG_trigger svg{transition:transform .12s}.GPyqUG_triggerOpen{transform:rotate(180deg)}.GPyqUG_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.GPyqUG_node{min-width:0;position:relative}.GPyqUG_menu>.GPyqUG_node{margin-left:-3px}.GPyqUG_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.GPyqUG_row:hover>.GPyqUG_clickarea,.GPyqUG_row:focus-visible>.GPyqUG_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.GPyqUG_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.GPyqUG_row>[data-state],.GPyqUG_clickarea>[data-state]{margin-top:4px}.GPyqUG_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.GPyqUG_disabled:hover{background:0 0}.GPyqUG_loadingRow{cursor:default}.GPyqUG_disclosure,.GPyqUG_disclosureSpace{flex:none;width:14px;height:18px}.GPyqUG_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.GPyqUG_disclosure:hover{color:var(--dsw-alias-label-primary)}.GPyqUG_disclosureOpen{transform:rotate(90deg)}.GPyqUG_content{flex-direction:column;flex:1;min-width:0;display:flex}.GPyqUG_label,.GPyqUG_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.GPyqUG_label{color:inherit;font-weight:400}.GPyqUG_summary,.GPyqUG_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.GPyqUG_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.GPyqUG_metricToken{grid-row:1;line-height:18px}.GPyqUG_metricDuration{grid-row:2}.GPyqUG_children{margin-left:18px;padding-left:4px;position:relative}.GPyqUG_children:before,.GPyqUG_children>.GPyqUG_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.GPyqUG_children:before{height:26px;top:-26px}.GPyqUG_children[aria-busy=true]:before{content:none}.GPyqUG_children>.GPyqUG_node:before{top:0;bottom:0;left:-4px}.GPyqUG_children>.GPyqUG_node:last-child:before{height:17px;bottom:auto}.GPyqUG_children>.GPyqUG_node>.GPyqUG_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.GPyqUG_notice,.GPyqUG_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.GPyqUG_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.GPyqUG_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.GPyqUG_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"node": "GPyqUG_node",
			"row": "GPyqUG_row",
			"clickarea": "GPyqUG_clickarea",
			"loadingRow": "GPyqUG_loadingRow",
			"summary": "GPyqUG_summary",
			"metrics": "GPyqUG_metrics",
			"notice": "GPyqUG_notice",
			"error": "GPyqUG_error",
			"count": "GPyqUG_count",
			"disclosureSpace": "GPyqUG_disclosureSpace",
			"root": "GPyqUG_root",
			"label": "GPyqUG_label",
			"metricToken": "GPyqUG_metricToken",
			"disclosure": "GPyqUG_disclosure",
			"metricDuration": "GPyqUG_metricDuration",
			"refresh": "GPyqUG_refresh",
			"disclosureOpen": "GPyqUG_disclosureOpen",
			"trigger": "GPyqUG_trigger",
			"activitySlot": "GPyqUG_activitySlot",
			"menu": "GPyqUG_menu",
			"content": "GPyqUG_content",
			"triggerOpen": "GPyqUG_triggerOpen",
			"disabled": "GPyqUG_disabled",
			"children": "GPyqUG_children"
		};
		//#endregion
		...
		*/
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "viWglG_frame" };
		//#endregion
