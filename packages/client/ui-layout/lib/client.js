window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-layout/src/client/AppFrame.module.css.mjs
		const css = "._ZATUa_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}._ZATUa_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){._ZATUa_frame{transition:none}}._ZATUa_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:1px solid var(--dsw-alias-border-l1);min-width:0;overflow:hidden}._ZATUa_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}._ZATUa_detailsCol{border-left:1px solid var(--dsw-alias-border-l2);min-width:0;overflow:hidden}._ZATUa_frame[data-details-collapsed] ._ZATUa_detailsCol{border-left:none}._ZATUa_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}._ZATUa_frame[data-dragging] ._ZATUa_handle{transition:none}@media (prefers-reduced-motion:reduce){._ZATUa_handle{transition:none}}._ZATUa_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}._ZATUa_detailsCol:hover~._ZATUa_handle[data-side=details]:after,._ZATUa_handle[data-side=details]:hover:after,._ZATUa_handle[data-side=details][data-dragging=true]:after{opacity:1}._ZATUa_handle[data-side=details]:hover:after,._ZATUa_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}._ZATUa_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}._ZATUa_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"frame": "_ZATUa_frame",
			"centerCol": "_ZATUa_centerCol",
			"handle": "_ZATUa_handle",
			"overlayLayer": "_ZATUa_overlayLayer",
			"sidebarCol": "_ZATUa_sidebarCol",
			"detailsCol": "_ZATUa_detailsCol"
		};
		//#endregion
