window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-theme/src/client/AppearanceRow.module.css.mjs
		const css = ".eeWr1a_group{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.eeWr1a_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.eeWr1a_cubeRow{flex-wrap:wrap;align-items:stretch;gap:8px;display:flex}.eeWr1a_themeCube{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:16px;flex-direction:column;flex:180px;justify-content:center;align-items:center;gap:4px;padding:20px 32px;font-size:14px;line-height:22px;display:flex}.eeWr1a_themeCube:hover:not(.eeWr1a_selected){background:var(--dsw-alias-interactive-bg-hover)}.eeWr1a_selected{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		...
		var AppearanceRow_module_css_default = {
			"cubeRow": "eeWr1a_cubeRow",
			"themeCube": "eeWr1a_themeCube",
			"title": "eeWr1a_title",
			"selected": "eeWr1a_selected",
			"group": "eeWr1a_group"
		};
		//#endregion
