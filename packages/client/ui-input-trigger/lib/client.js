window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-input-trigger/src/client/MenuView.module.css.mjs
		const css = "._52Enxa_menu{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);min-width:min(260px,100%);max-width:min(537px,100%);max-height:320px;box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;overflow:hidden}._52Enxa_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}._52Enxa_item{cursor:pointer;width:100%;min-height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:8px 10px;font-size:14px;line-height:22px;display:flex}._52Enxa_item:hover,._52Enxa_item._52Enxa_active{background:var(--dsw-alias-interactive-bg-hover)}._52Enxa_itemIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}._52Enxa_itemName{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}._52Enxa_itemDescription{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}._52Enxa_groupTitle{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px;line-height:16px}._52Enxa_loading{min-height:40px;color:var(--dsw-alias-label-dimmed);align-items:center;padding:8px 10px;font-size:14px;line-height:22px;display:flex}";
		...
		var MenuView_module_css_default = {
			"loading": "_52Enxa_loading",
			"groupTitle": "_52Enxa_groupTitle",
			"itemDescription": "_52Enxa_itemDescription",
			"menu": "_52Enxa_menu",
			"viewport": "_52Enxa_viewport",
			"item": "_52Enxa_item",
			"itemIcon": "_52Enxa_itemIcon",
			"itemName": "_52Enxa_itemName",
			"active": "_52Enxa_active"
		};
		//#endregion
