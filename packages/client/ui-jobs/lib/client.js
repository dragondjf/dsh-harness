window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-jobs/src/client/JobListAction.module.css.mjs
		const css = ".xAtW9W_root{position:relative}.xAtW9W_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.xAtW9W_trigger:hover,.xAtW9W_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.xAtW9W_trigger svg{transition:transform .12s}.xAtW9W_triggerOpen{transform:rotate(180deg)}.xAtW9W_triggerDot{flex:none}.xAtW9W_count{margin:0 5px}.xAtW9W_menu{z-index:100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.xAtW9W_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.xAtW9W_rowSettled{color:var(--dsw-alias-label-tertiary)}.xAtW9W_rowDot{flex:none}.xAtW9W_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.xAtW9W_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.xAtW9W_status,.xAtW9W_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.xAtW9W_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.xAtW9W_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"rowSettled": "xAtW9W_rowSettled",
			"count": "xAtW9W_count",
			"status": "xAtW9W_status",
			"triggerDot": "xAtW9W_triggerDot",
			"menu": "xAtW9W_menu",
			"rowDot": "xAtW9W_rowDot",
			"label": "xAtW9W_label",
			"duration": "xAtW9W_duration",
			"kind": "xAtW9W_kind",
			"row": "xAtW9W_row",
			"trigger": "xAtW9W_trigger",
			"triggerOpen": "xAtW9W_triggerOpen",
			"root": "xAtW9W_root"
		};
		//#endregion
