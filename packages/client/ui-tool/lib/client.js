window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".xhZBNW_root{flex-direction:column;display:flex}.xhZBNW_row{position:relative;overflow:hidden}.xhZBNW_root[data-state=running] .xhZBNW_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite xhZBNW_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes xhZBNW_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.xhZBNW_leading{flex-shrink:0}.xhZBNW_root[data-tool^=cordis_] .xhZBNW_leading,.xhZBNW_root[data-tool^=cordis_] .xhZBNW_title{color:var(--dsw-alias-state-business-primary)}.xhZBNW_root[data-tool^=cordis_] .xhZBNW_title{font-weight:500}.xhZBNW_root[data-tool^=cordis_] .xhZBNW_sep{background:var(--dsw-alias-state-business-primary)}.xhZBNW_chevron{color:var(--dsw-alias-label-secondary)}.xhZBNW_title{font-weight:400}.xhZBNW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.xhZBNW_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.xhZBNW_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.xhZBNW_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.xhZBNW_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.xhZBNW_errorSummary{color:var(--dsw-alias-state-error-primary)}.xhZBNW_bodyWrap{flex-direction:column;display:flex}.xhZBNW_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.xhZBNW_root:hover .xhZBNW_inspectButton,.xhZBNW_inspectButton:focus-visible{opacity:1}.xhZBNW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.xhZBNW_bodyScroll{max-height:260px;overflow-y:auto}.xhZBNW_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.xhZBNW_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.xhZBNW_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.xhZBNW_ioSection::-webkit-scrollbar-track{margin:6px 0}.xhZBNW_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.xhZBNW_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.xhZBNW_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.xhZBNW_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.xhZBNW_codeBody,.xhZBNW_terminalBody,.xhZBNW_diffBody,.xhZBNW_readBody,.xhZBNW_searchBody,.xhZBNW_webBody{margin:4px 0 4px 4px}.xhZBNW_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.xhZBNW_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.xhZBNW_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.xhZBNW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"readBody": "xhZBNW_readBody",
			"bodyWrap": "xhZBNW_bodyWrap",
			"fileLink": "xhZBNW_fileLink",
			"root": "xhZBNW_root",
			"leading": "xhZBNW_leading",
			"dsh-tool-row-sweep": "xhZBNW_dsh-tool-row-sweep",
			"title": "xhZBNW_title",
			"sep": "xhZBNW_sep",
			"summary": "xhZBNW_summary",
			"row": "xhZBNW_row",
			"chevron": "xhZBNW_chevron",
			"summarySuffix": "xhZBNW_summarySuffix",
			"errorSummary": "xhZBNW_errorSummary",
			"terminalBody": "xhZBNW_terminalBody",
			"ioCard": "xhZBNW_ioCard",
			"ioSection": "xhZBNW_ioSection",
			"searchBody": "xhZBNW_searchBody",
			"codeBody": "xhZBNW_codeBody",
			"searchRecovery": "xhZBNW_searchRecovery",
			"visuallyHidden": "xhZBNW_visuallyHidden",
			"ioLabel": "xhZBNW_ioLabel",
			"inspectButton": "xhZBNW_inspectButton",
			"ioDivider": "xhZBNW_ioDivider",
			"ioText": "xhZBNW_ioText",
			"bodyScroll": "xhZBNW_bodyScroll",
			"webBody": "xhZBNW_webBody",
			"diffBody": "xhZBNW_diffBody"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = "._6aoTbW_callRow{border-radius:6px}._6aoTbW_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"subCalls": "_6aoTbW_subCalls",
			"callRow": "_6aoTbW_callRow"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".ZNAG2q_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.ZNAG2q_cardBody{margin:0}.ZNAG2q_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.ZNAG2q_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.ZNAG2q_code[data-error]{color:var(--dsw-alias-state-error-primary)}.ZNAG2q_read,.ZNAG2q_web{margin:0}.ZNAG2q_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			...
			"web": "ZNAG2q_web",
			"empty": "ZNAG2q_empty",
			"description": "ZNAG2q_description",
			"cardBody": "ZNAG2q_cardBody",
			"recovery": "ZNAG2q_recovery",
			"code": "ZNAG2q_code"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".CmpfQa_card{flex-direction:column;display:flex}.CmpfQa_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.CmpfQa_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.CmpfQa_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.CmpfQa_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.CmpfQa_ioSection::-webkit-scrollbar-track{margin:6px 0}.CmpfQa_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.CmpfQa_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.CmpfQa_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.CmpfQa_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.CmpfQa_root[data-expandable]{cursor:pointer}.CmpfQa_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.CmpfQa_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite CmpfQa_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes CmpfQa_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.CmpfQa_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.CmpfQa_chevron{color:var(--dsw-alias-label-secondary)}.CmpfQa_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.CmpfQa_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.CmpfQa_root:hover .CmpfQa_iconIdle{opacity:0}.CmpfQa_root:hover .CmpfQa_chevronHover{opacity:1}.CmpfQa_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.CmpfQa_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.CmpfQa_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.CmpfQa_errorSummary{color:var(--dsw-alias-state-error-primary)}.CmpfQa_bodyWrap{flex-direction:column;display:flex}.CmpfQa_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.CmpfQa_card:hover .CmpfQa_inspectButton,.CmpfQa_inspectButton:focus-visible{opacity:1}.CmpfQa_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.CmpfQa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"chevronHover": "CmpfQa_chevronHover",
			"dsh-bash-row-sweep": "CmpfQa_dsh-bash-row-sweep",
			"ioSection": "CmpfQa_ioSection",
			"ioText": "CmpfQa_ioText",
			"ioCard": "CmpfQa_ioCard",
			"sep": "CmpfQa_sep",
			"leading": "CmpfQa_leading",
			"title": "CmpfQa_title",
			"iconIdle": "CmpfQa_iconIdle",
			"summary": "CmpfQa_summary",
			"chevron": "CmpfQa_chevron",
			"card": "CmpfQa_card",
			"ioDivider": "CmpfQa_ioDivider",
			"bodyWrap": "CmpfQa_bodyWrap",
			"visuallyHidden": "CmpfQa_visuallyHidden",
			"terminal": "CmpfQa_terminal",
			"ioLabel": "CmpfQa_ioLabel",
			"errorSummary": "CmpfQa_errorSummary",
			"root": "CmpfQa_root",
			"inspectButton": "CmpfQa_inspectButton"
		};
		//#endregion
