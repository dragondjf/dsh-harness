window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$2 = ".e6qdla_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.e6qdla_field+.e6qdla_field{border-top:1px solid var(--dsw-alias-border-l2)}.e6qdla_head{align-items:center;gap:8px;display:flex}.e6qdla_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.e6qdla_badges{align-items:center;gap:8px;display:inline-flex}.e6qdla_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.e6qdla_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.e6qdla_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.e6qdla_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.e6qdla_reset:disabled{cursor:default}.e6qdla_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.e6qdla_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.e6qdla_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.e6qdla_inputInvalid{border-color:var(--dsw-alias-label-error);}.e6qdla_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.e6qdla_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"label": "e6qdla_label",
			"badge": "e6qdla_badge",
			"badges": "e6qdla_badges",
			"input": "e6qdla_input",
			"inputInvalid": "e6qdla_inputInvalid",
			"invalid": "e6qdla_invalid",
			"hint": "e6qdla_hint",
			"head": "e6qdla_head",
			"field": "e6qdla_field",
			"badgeMuted": "e6qdla_badgeMuted",
			"reset": "e6qdla_reset"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$1 = ".x2fOYq_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.x2fOYq_card:hover{border-color:var(--dsw-alias-label-dimmed)}.x2fOYq_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.x2fOYq_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.x2fOYq_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.x2fOYq_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.x2fOYq_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.x2fOYq_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.x2fOYq_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.x2fOYq_chevronOpen{transform:rotate(180deg)}.x2fOYq_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.x2fOYq_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.x2fOYq_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.x2fOYq_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.x2fOYq_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.x2fOYq_discard,.x2fOYq_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.x2fOYq_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.x2fOYq_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.x2fOYq_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.x2fOYq_discard:disabled,.x2fOYq_save:disabled{opacity:.4;cursor:default}.x2fOYq_discard:focus-visible,.x2fOYq_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"chevron": "x2fOYq_chevron",
			"discard": "x2fOYq_discard",
			"pending": "x2fOYq_pending",
			"cardOpen": "x2fOYq_cardOpen",
			"save": "x2fOYq_save",
			"headText": "x2fOYq_headText",
			"card": "x2fOYq_card",
			"footer": "x2fOYq_footer",
			"failed": "x2fOYq_failed",
			"name": "x2fOYq_name",
			"body": "x2fOYq_body",
			"header": "x2fOYq_header",
			"description": "x2fOYq_description",
			"chevronOpen": "x2fOYq_chevronOpen",
			"readOnly": "x2fOYq_readOnly"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css = ".kiuBMa_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.kiuBMa_heading{margin:0;font-size:18px;font-weight:600}.kiuBMa_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.kiuBMa_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.kiuBMa_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.kiuBMa_tab:hover,.kiuBMa_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.kiuBMa_tab[data-active=true]:after,.kiuBMa_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.kiuBMa_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.kiuBMa_panel{min-width:0;padding-top:2px}.kiuBMa_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.kiuBMa_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"intro": "kiuBMa_intro",
			"empty": "kiuBMa_empty",
			"heading": "kiuBMa_heading",
			"panel": "kiuBMa_panel",
			"tabs": "kiuBMa_tabs",
			"cards": "kiuBMa_cards",
			"tab": "kiuBMa_tab",
			"section": "kiuBMa_section"
		};
		//#endregion
