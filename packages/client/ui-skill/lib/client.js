window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-skill/src/client/SkillRow.module.css.mjs
		const css = ".qDDcoa_card{flex-direction:column;display:flex}.qDDcoa_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.qDDcoa_row[data-expandable]{cursor:pointer}.qDDcoa_card[data-state=running] .qDDcoa_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite qDDcoa_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes qDDcoa_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}.qDDcoa_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.qDDcoa_chevron{color:var(--dsw-alias-label-secondary)}.qDDcoa_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.qDDcoa_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.qDDcoa_row:hover .qDDcoa_iconIdle{opacity:0}.qDDcoa_row:hover .qDDcoa_chevronHover{opacity:1}.qDDcoa_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.qDDcoa_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.qDDcoa_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.qDDcoa_errorSummary{color:var(--dsw-alias-state-error-primary)}.qDDcoa_bodyWrap{flex-direction:column;display:flex}.qDDcoa_instructionsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}.qDDcoa_instructionsHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}.qDDcoa_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}.qDDcoa_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}.qDDcoa_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.qDDcoa_instructions::-webkit-scrollbar-track{margin:6px 0}.qDDcoa_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.qDDcoa_card:hover .qDDcoa_inspectButton,.qDDcoa_inspectButton:focus-visible{opacity:1}.qDDcoa_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.qDDcoa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.qDDcoa_card[data-state=running] .qDDcoa_row:after{animation:none;display:none}.qDDcoa_iconIdle,.qDDcoa_chevronHover,.qDDcoa_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"instructions": "qDDcoa_instructions",
			"summary": "qDDcoa_summary",
			"inspectButton": "qDDcoa_inspectButton",
			"card": "qDDcoa_card",
			"errorSummary": "qDDcoa_errorSummary",
			"row": "qDDcoa_row",
			"instructionsHeader": "qDDcoa_instructionsHeader",
			"instructionsCard": "qDDcoa_instructionsCard",
			"separator": "qDDcoa_separator",
			"chevron": "qDDcoa_chevron",
			"leading": "qDDcoa_leading",
			"visuallyHidden": "qDDcoa_visuallyHidden",
			"iconIdle": "qDDcoa_iconIdle",
			"dsh-skill-row-sweep": "qDDcoa_dsh-skill-row-sweep",
			"bodyWrap": "qDDcoa_bodyWrap",
			"title": "qDDcoa_title",
			"chevronHover": "qDDcoa_chevronHover"
		};
		//#endregion
