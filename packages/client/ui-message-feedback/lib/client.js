window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-message-feedback/src/client/MessageFeedbackActions.module.css.mjs
		const css = ".RDEriq_action{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:6px;display:inline-flex}.RDEriq_action:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.RDEriq_action:disabled{cursor:default;opacity:.4}.RDEriq_action[data-active]{color:var(--dsw-alias-label-primary)}.RDEriq_noteOpen{max-width:220px;color:var(--dsw-alias-label-tertiary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:14px;padding:0 8px;font-size:13px;line-height:28px;overflow:hidden}.RDEriq_noteOpen:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.RDEriq_noteEditor{align-items:flex-start;gap:6px;display:inline-flex}.RDEriq_noteInput{border:1px solid var(--dsw-alias-border-secondary);background:var(--dsw-alias-bg-primary);width:260px;color:var(--dsw-alias-label-primary);font:inherit;resize:vertical;border-radius:8px;padding:6px 8px;font-size:13px}.RDEriq_noteSave,.RDEriq_noteCancel{cursor:pointer;border:none;border-radius:14px;height:28px;padding:0 10px;font-size:13px}.RDEriq_noteSave{background:var(--dsw-alias-interactive-bg-primary);color:var(--dsw-alias-label-inverse)}.RDEriq_noteSave:disabled{cursor:default;opacity:.4}.RDEriq_noteCancel{color:var(--dsw-alias-label-tertiary);background:0 0}.RDEriq_noteCancel:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.RDEriq_failure{color:var(--dsw-alias-label-tertiary);padding-left:4px;font-size:13px;line-height:28px}";
		...
		var MessageFeedbackActions_module_css_default = {
			"noteOpen": "RDEriq_noteOpen",
			"action": "RDEriq_action",
			"noteEditor": "RDEriq_noteEditor",
			"noteInput": "RDEriq_noteInput",
			"noteSave": "RDEriq_noteSave",
			"noteCancel": "RDEriq_noteCancel",
			"failure": "RDEriq_failure"
		};
		//#endregion
