window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-user-questions/src/client/PlanReviewPanel.module.css.mjs
		const css$1 = "._9XyfCG_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}._9XyfCG_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}._9XyfCG_card,._9XyfCG_card *{box-sizing:border-box}._9XyfCG_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}._9XyfCG_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}._9XyfCG_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}._9XyfCG_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}._9XyfCG_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}._9XyfCG_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}._9XyfCG_discuss{color:var(--dsw-alias-label-secondary);gap:6px}._9XyfCG_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){._9XyfCG_card{border-radius:16px}._9XyfCG_body{padding:10px 12px 4px}._9XyfCG_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			...
			"frame": "_9XyfCG_frame",
			"dot": "_9XyfCG_dot",
			"actions": "_9XyfCG_actions",
			"footer": "_9XyfCG_footer",
			"card": "_9XyfCG_card",
			"discuss": "_9XyfCG_discuss",
			"body": "_9XyfCG_body",
			"feedback": "_9XyfCG_feedback"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-user-questions/src/client/QuestionComposer.module.css.mjs
		const css = ".qU5c1G_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.qU5c1G_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.qU5c1G_card,.qU5c1G_card *{box-sizing:border-box}.qU5c1G_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.qU5c1G_headingBlock{min-width:0}.qU5c1G_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.qU5c1G_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.qU5c1G_detail{margin:0 2px 8px}.qU5c1G_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.qU5c1G_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.qU5c1G_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.qU5c1G_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.qU5c1G_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.qU5c1G_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.qU5c1G_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.qU5c1G_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.qU5c1G_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.qU5c1G_option:hover:not(:disabled),.qU5c1G_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.qU5c1G_optionSelected{border-color:var(--dsw-alias-border-l2)}.qU5c1G_option:disabled{cursor:default}.qU5c1G_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.qU5c1G_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.qU5c1G_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.qU5c1G_checkbox>svg{grid-area:1/1}.qU5c1G_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.qU5c1G_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.qU5c1G_optionCopy{flex:1;min-width:0}.qU5c1G_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.qU5c1G_optionLabel{font-size:14px;font-weight:500;line-height:24px}.qU5c1G_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.qU5c1G_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.qU5c1G_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.qU5c1G_customRow:hover,.qU5c1G_customRow:focus-within,.qU5c1G_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.qU5c1G_customRow:focus-within,.qU5c1G_customRowActive{border-color:var(--dsw-alias-border-l2)}.qU5c1G_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.qU5c1G_customInput::placeholder{color:var(--dsw-alias-label-caption)}.qU5c1G_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.qU5c1G_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.qU5c1G_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.qU5c1G_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.qU5c1G_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.qU5c1G_card{border-radius:16px}.qU5c1G_header{padding:10px 12px 0 18px}.qU5c1G_options{padding:4px 8px}.qU5c1G_title{font-size:15px;line-height:21px}.qU5c1G_option,.qU5c1G_customRow{padding:8px 6px}.qU5c1G_footer{align-items:flex-end;padding:0 10px}.qU5c1G_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.qU5c1G_option,.qU5c1G_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"checkboxChecked": "qU5c1G_checkboxChecked",
			"iconButton": "qU5c1G_iconButton",
			"optionLine": "qU5c1G_optionLine",
			"detail": "qU5c1G_detail",
			"options": "qU5c1G_options",
			"footerActions": "qU5c1G_footerActions",
			"customRow": "qU5c1G_customRow",
			"title": "qU5c1G_title",
			"frame": "qU5c1G_frame",
			"card": "qU5c1G_card",
			"optionLabel": "qU5c1G_optionLabel",
			"headingBlock": "qU5c1G_headingBlock",
			"pager": "qU5c1G_pager",
			"customTextarea": "qU5c1G_customTextarea",
			"feedback": "qU5c1G_feedback",
			"customRowActive": "qU5c1G_customRowActive",
			"optionSelected": "qU5c1G_optionSelected",
			"option": "qU5c1G_option",
			"footer": "qU5c1G_footer",
			"eyebrow": "qU5c1G_eyebrow",
			"progress": "qU5c1G_progress",
			"header": "qU5c1G_header",
			"number": "qU5c1G_number",
			"optionCopy": "qU5c1G_optionCopy",
			"badge": "qU5c1G_badge",
			"body": "qU5c1G_body",
			"description": "qU5c1G_description",
			"customInput": "qU5c1G_customInput",
			"checkbox": "qU5c1G_checkbox"
		};
		//#endregion
