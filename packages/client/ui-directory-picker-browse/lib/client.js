window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = "._1_ztKW_dialog._1_ztKW_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}._1_ztKW_editorScope{display:contents}._1_ztKW_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}._1_ztKW_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}._1_ztKW_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}._1_ztKW_crumbBar:has(._1_ztKW_crumbEditZone:enabled:hover),._1_ztKW_crumbBar:has(._1_ztKW_crumbEditZone:focus-visible),._1_ztKW_crumbBar:has(._1_ztKW_pathInput){border-color:var(--dsw-alias-border-l2)}._1_ztKW_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}._1_ztKW_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}._1_ztKW_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}._1_ztKW_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}._1_ztKW_crumb:hover{color:var(--dsw-alias-label-primary)}._1_ztKW_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}._1_ztKW_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}._1_ztKW_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}._1_ztKW_crumbEditZone:enabled:hover ._1_ztKW_crumbEditGlyph,._1_ztKW_crumbEditZone:focus-visible ._1_ztKW_crumbEditGlyph{color:var(--dsw-alias-label-primary)}._1_ztKW_crumbEditZone:disabled{cursor:default}._1_ztKW_crumbEditZone:disabled ._1_ztKW_crumbEditGlyph{color:var(--dsw-alias-label-caption)}._1_ztKW_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}._1_ztKW_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}._1_ztKW_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}._1_ztKW_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}._1_ztKW_rowSeat{flex:none;display:flex}._1_ztKW_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}._1_ztKW_row:hover{background:var(--dsw-alias-interactive-bg-hover)}._1_ztKW_rowSelected,._1_ztKW_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}._1_ztKW_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}._1_ztKW_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}._1_ztKW_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}._1_ztKW_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}._1_ztKW_status,._1_ztKW_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}._1_ztKW_status{color:var(--dsw-alias-label-secondary)}._1_ztKW_error{color:var(--dsw-alias-state-error-primary)}._1_ztKW_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}._1_ztKW_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}._1_ztKW_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}._1_ztKW_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}._1_ztKW_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}._1_ztKW_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}._1_ztKW_footerGap{flex:1 1 0}._1_ztKW_footerAction{min-width:72px}._1_ztKW_createDialog._1_ztKW_createDialog{gap:0;width:min(380px,100%);padding:0}._1_ztKW_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}._1_ztKW_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}._1_ztKW_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}._1_ztKW_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}._1_ztKW_createInput::placeholder{color:var(--dsw-alias-label-caption)}._1_ztKW_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"loadingFloat": "_1_ztKW_loadingFloat",
			"rowSeat": "_1_ztKW_rowSeat",
			"crumbEditZone": "_1_ztKW_crumbEditZone",
			"rowIcon": "_1_ztKW_rowIcon",
			"rowChevron": "_1_ztKW_rowChevron",
			"column": "_1_ztKW_column",
			"createDialog": "_1_ztKW_createDialog",
			"rowSelected": "_1_ztKW_rowSelected",
			"createBody": "_1_ztKW_createBody",
			"createTitle": "_1_ztKW_createTitle",
			"crumbSeat": "_1_ztKW_crumbSeat",
			"crumbChevron": "_1_ztKW_crumbChevron",
			"dialog": "_1_ztKW_dialog",
			"row": "_1_ztKW_row",
			"showHiddenToggleActive": "_1_ztKW_showHiddenToggleActive",
			"createIn": "_1_ztKW_createIn",
			"editorScope": "_1_ztKW_editorScope",
			"crumbEditGlyph": "_1_ztKW_crumbEditGlyph",
			"millerRow": "_1_ztKW_millerRow",
			"rowName": "_1_ztKW_rowName",
			"pathInput": "_1_ztKW_pathInput",
			"footerAction": "_1_ztKW_footerAction",
			"error": "_1_ztKW_error",
			"title": "_1_ztKW_title",
			"showHiddenToggle": "_1_ztKW_showHiddenToggle",
			"rowIconSelected": "_1_ztKW_rowIconSelected",
			"createActions": "_1_ztKW_createActions",
			"footerBar": "_1_ztKW_footerBar",
			"crumbTrail": "_1_ztKW_crumbTrail",
			"crumb": "_1_ztKW_crumb",
			"divider": "_1_ztKW_divider",
			"content": "_1_ztKW_content",
			"header": "_1_ztKW_header",
			"status": "_1_ztKW_status",
			"footerGap": "_1_ztKW_footerGap",
			"createInput": "_1_ztKW_createInput",
			"crumbBar": "_1_ztKW_crumbBar"
		};
		//#endregion
