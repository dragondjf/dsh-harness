window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-workflow-run/src/client/WorkflowRunPanel.module.css.mjs
		const css = ".IxKYEa_root{width:100%;min-width:0}.IxKYEa_runHeader{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border-radius:8px;align-items:center;gap:6px;width:100%;min-width:0;height:32px;padding:0 8px;display:flex}.IxKYEa_runHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.IxKYEa_runLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.IxKYEa_runTitle{max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:14px;font-weight:510;line-height:24px;overflow:hidden}.IxKYEa_runSummary{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.IxKYEa_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}.IxKYEa_phaseHeader{box-sizing:border-box;align-items:center;gap:6px;width:100%;min-width:0;height:32px;display:flex}.IxKYEa_phaseHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px;border-radius:4px}.IxKYEa_phaseLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.IxKYEa_phaseTitle{min-width:0;max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:14px;line-height:24px;overflow:hidden}.IxKYEa_phaseCount{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}.IxKYEa_phaseStatus{width:132px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}.IxKYEa_separator{background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:2px;height:2px}.IxKYEa_phaseList{flex-direction:column;gap:4px;min-width:0;padding:4px 0 0 16px;display:flex}.IxKYEa_phase{min-width:0}.IxKYEa_members{flex-direction:column;gap:2px;min-width:0;padding:0 0 0 16px;display:flex}.IxKYEa_memberRow,.IxKYEa_memberButton{width:100%;min-width:0;min-height:24px;color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;background:0 0;border:0;border-radius:4px;align-items:center;gap:12px;padding:0;display:flex}.IxKYEa_memberButton{cursor:pointer}.IxKYEa_memberButton .IxKYEa_memberLabel{color:var(--dsw-alias-state-business-primary);text-underline-position:from-font;text-decoration:underline}.IxKYEa_dotSlot{flex:none;justify-content:center;align-items:center;width:16px;height:24px;display:inline-flex;overflow:hidden}.IxKYEa_memberButton:focus-visible{outline:none}.IxKYEa_memberButton:focus-visible .IxKYEa_memberLabelWrap{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.IxKYEa_memberLabelWrap{border-radius:4px;flex:1;align-items:center;min-width:0;height:24px;padding:0 2px;display:flex;overflow:hidden}.IxKYEa_memberLabel{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:14px;line-height:24px;overflow:hidden}.IxKYEa_memberStatus{width:64px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}.IxKYEa_empty{color:var(--dsw-alias-label-tertiary);padding:0;font-size:13px;line-height:20px}@media (width<=560px){.IxKYEa_phaseList,.IxKYEa_members{padding-left:12px}}";
		...
		var WorkflowRunPanel_module_css_default = {
			"memberLabelWrap": "IxKYEa_memberLabelWrap",
			"memberStatus": "IxKYEa_memberStatus",
			"runTitle": "IxKYEa_runTitle",
			"root": "IxKYEa_root",
			"phaseLeading": "IxKYEa_phaseLeading",
			"runSummary": "IxKYEa_runSummary",
			"phaseTitle": "IxKYEa_phaseTitle",
			"memberRow": "IxKYEa_memberRow",
			"memberLabel": "IxKYEa_memberLabel",
			"runLeading": "IxKYEa_runLeading",
			"statusTail": "IxKYEa_statusTail",
			"memberButton": "IxKYEa_memberButton",
			"runHeader": "IxKYEa_runHeader",
			"empty": "IxKYEa_empty",
			"phaseStatus": "IxKYEa_phaseStatus",
			"phaseCount": "IxKYEa_phaseCount",
			"members": "IxKYEa_members",
			"phaseList": "IxKYEa_phaseList",
			"separator": "IxKYEa_separator",
			"phase": "IxKYEa_phase",
			"phaseHeader": "IxKYEa_phaseHeader",
			"dotSlot": "IxKYEa_dotSlot"
		};
		//#endregion
