window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetRow.module.css.mjs
		const css$2 = ".i4vzNa_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.i4vzNa_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.i4vzNa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.i4vzNa_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.i4vzNa_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.i4vzNa_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.i4vzNa_selector:disabled{cursor:default}.i4vzNa_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"desc": "i4vzNa_desc",
			"selector": "i4vzNa_selector",
			"chevron": "i4vzNa_chevron",
			"rowText": "i4vzNa_rowText",
			"title": "i4vzNa_title",
			"row": "i4vzNa_row"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetSeat.module.css.mjs
		const css$1 = ".lHJSfG_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.lHJSfG_seat:not(:disabled):hover,.lHJSfG_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.lHJSfG_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.lHJSfG_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.lHJSfG_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both lHJSfG_seat-icon-in}@keyframes lHJSfG_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.lHJSfG_introText{white-space:pre;display:inline-block}.lHJSfG_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards lHJSfG_seat-char-in;display:inline-block}@keyframes lHJSfG_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.lHJSfG_introIcon,.lHJSfG_introChar{opacity:1;animation:none}}.lHJSfG_chevron{color:var(--dsw-alias-label-caption);flex:none}.lHJSfG_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.lHJSfG_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.lHJSfG_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"seat": "lHJSfG_seat",
			"introIcon": "lHJSfG_introIcon",
			"introText": "lHJSfG_introText",
			"item": "lHJSfG_item",
			"chevron": "lHJSfG_chevron",
			"seatIcon": "lHJSfG_seatIcon",
			"itemName": "lHJSfG_itemName",
			"itemDesc": "lHJSfG_itemDesc",
			"seat-char-in": "lHJSfG_seat-char-in",
			"seat-icon-in": "lHJSfG_seat-icon-in",
			"introChar": "lHJSfG_introChar"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetSection.module.css.mjs
		const css = ".clZClq_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.clZClq_title{margin:0;font-size:18px;font-weight:600}.clZClq_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.clZClq_group{flex-direction:column;gap:10px;display:flex}.clZClq_group+.clZClq_group{margin-top:20px}.clZClq_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.clZClq_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.clZClq_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.clZClq_card:hover:not(.clZClq_cardActive){border-color:var(--dsw-alias-label-dimmed)}.clZClq_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.clZClq_cardBroken,.clZClq_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.clZClq_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.clZClq_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.clZClq_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.clZClq_cardMain:disabled{cursor:default}.clZClq_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.clZClq_cardHead{align-items:center;gap:8px;display:flex}.clZClq_cardName{font-size:15px;font-weight:600;line-height:1.4}.clZClq_badge,.clZClq_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.clZClq_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.clZClq_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.clZClq_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.clZClq_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.clZClq_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.clZClq_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.clZClq_iconButton:disabled{opacity:.4;cursor:default}.clZClq_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.clZClq_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.clZClq_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.clZClq_iconButton:hover:after,.clZClq_iconButton:focus-visible:after{opacity:1}.clZClq_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.clZClq_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.clZClq_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.clZClq_revealedPathLabel{white-space:nowrap}.clZClq_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.clZClq_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.clZClq_secondaryButton:disabled{opacity:.5;cursor:default}.clZClq_field{flex-direction:column;gap:6px;display:flex}.clZClq_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.clZClq_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.clZClq_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.clZClq_input::placeholder{color:var(--dsw-alias-label-dimmed)}.clZClq_dialog{width:min(560px,100%)}.clZClq_dialogFields{flex-direction:column;gap:12px;display:flex}.clZClq_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.clZClq_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.clZClq_deleteDialog{width:min(480px,100%)}.clZClq_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.clZClq_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.clZClq_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.clZClq_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.clZClq_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"cards": "clZClq_cards",
			"intro": "clZClq_intro",
			"cardBroken": "clZClq_cardBroken",
			"cardFoot": "clZClq_cardFoot",
			"field": "clZClq_field",
			"error": "clZClq_error",
			"brokenBadge": "clZClq_brokenBadge",
			"revealedPath": "clZClq_revealedPath",
			"badge": "clZClq_badge",
			"title": "clZClq_title",
			"viewerCode": "clZClq_viewerCode",
			"cardActive": "clZClq_cardActive",
			"iconDanger": "clZClq_iconDanger",
			"cardHead": "clZClq_cardHead",
			"dialogFields": "clZClq_dialogFields",
			"iconButton": "clZClq_iconButton",
			"section": "clZClq_section",
			"cardDesc": "clZClq_cardDesc",
			"group": "clZClq_group",
			"cardBrokenReason": "clZClq_cardBrokenReason",
			"dialog": "clZClq_dialog",
			"secondaryButton": "clZClq_secondaryButton",
			"cardId": "clZClq_cardId",
			"creatorButton": "clZClq_creatorButton",
			"card": "clZClq_card",
			"revealedPathLabel": "clZClq_revealedPathLabel",
			"fieldLabel": "clZClq_fieldLabel",
			"deleteDialog": "clZClq_deleteDialog",
			"input": "clZClq_input",
			"cardMain": "clZClq_cardMain",
			"deleteConfirm": "clZClq_deleteConfirm",
			"cardName": "clZClq_cardName",
			"inUse": "clZClq_inUse",
			"groupHead": "clZClq_groupHead"
		};
		//#endregion
