window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-settings-general/src/client/SettingsRoot.module.css.mjs
		const css$3 = ".n78u-W_trigger{box-sizing:border-box;cursor:pointer;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}.n78u-W_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.n78u-W_trigger.n78u-W_rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}.n78u-W_triggerLabel{white-space:nowrap;overflow:hidden}.n78u-W_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.n78u-W_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.n78u-W_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:24px;display:flex;position:relative;overflow:hidden}.n78u-W_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}.n78u-W_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}.n78u-W_navList{flex-direction:column;gap:4px;display:flex}.n78u-W_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}.n78u-W_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}.n78u-W_navCell.n78u-W_active{background:var(--dsw-specific-sidebar-nav-item-active)}.n78u-W_navIcon{flex:none}.n78u-W_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}.n78u-W_content{flex-direction:column;flex:1;min-width:0;display:flex}.n78u-W_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}.n78u-W_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}.n78u-W_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}.n78u-W_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.n78u-W_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}.n78u-W_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"close": "n78u-W_close",
			"panel": "n78u-W_panel",
			"active": "n78u-W_active",
			"navList": "n78u-W_navList",
			"mask": "n78u-W_mask",
			"navLabel": "n78u-W_navLabel",
			"nav": "n78u-W_nav",
			"content": "n78u-W_content",
			"hiddenLabel": "n78u-W_hiddenLabel",
			"navTitle": "n78u-W_navTitle",
			"navCell": "n78u-W_navCell",
			"options": "n78u-W_options",
			"header": "n78u-W_header",
			"rail": "n78u-W_rail",
			"actions": "n78u-W_actions",
			"triggerLabel": "n78u-W_triggerLabel",
			"navIcon": "n78u-W_navIcon",
			"overlay": "n78u-W_overlay",
			"trigger": "n78u-W_trigger"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-settings-general/src/client/chrome.module.css.mjs
		const css$2 = "._4SSkDG_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "_4SSkDG_triggerLabel" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-settings-general/src/client/GeneralSection.module.css.mjs
		const css$1 = ".g-aycq_section{flex-direction:column;width:100%;display:flex}.g-aycq_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "g-aycq_section" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-settings-general/src/client/SettingsDocumentAction.module.css.mjs
		const css = ".E5MWRq_action{align-items:center;gap:8px;min-width:0;display:flex}.E5MWRq_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
