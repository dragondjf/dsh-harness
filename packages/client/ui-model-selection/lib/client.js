window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = ".BhaBTW_root{min-width:0;position:relative}.BhaBTW_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.BhaBTW_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.BhaBTW_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.BhaBTW_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.BhaBTW_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.BhaBTW_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.BhaBTW_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.BhaBTW_chevronOpen{transform:rotate(180deg)}.BhaBTW_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.BhaBTW_status,.BhaBTW_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.BhaBTW_error,.BhaBTW_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.BhaBTW_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.BhaBTW_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.BhaBTW_groups{min-height:0;overflow-y:auto}.BhaBTW_group+.BhaBTW_group{margin-top:4px}.BhaBTW_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.BhaBTW_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.BhaBTW_option:hover:not(:disabled),.BhaBTW_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.BhaBTW_selected{background:0 0}.BhaBTW_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.BhaBTW_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.BhaBTW_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.BhaBTW_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.BhaBTW_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.BhaBTW_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.BhaBTW_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.BhaBTW_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.BhaBTW_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.BhaBTW_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"group": "BhaBTW_group",
			"triggerEffort": "BhaBTW_triggerEffort",
			"description": "BhaBTW_description",
			"cellChevron": "BhaBTW_cellChevron",
			"triggerLabel": "BhaBTW_triggerLabel",
			"menu": "BhaBTW_menu",
			"selected": "BhaBTW_selected",
			"cell": "BhaBTW_cell",
			"cellValue": "BhaBTW_cellValue",
			"chevronOpen": "BhaBTW_chevronOpen",
			"status": "BhaBTW_status",
			"option": "BhaBTW_option",
			"modelName": "BhaBTW_modelName",
			"warning": "BhaBTW_warning",
			"optionCopy": "BhaBTW_optionCopy",
			"root": "BhaBTW_root",
			"retry": "BhaBTW_retry",
			"check": "BhaBTW_check",
			"groups": "BhaBTW_groups",
			"error": "BhaBTW_error",
			"groupTitle": "BhaBTW_groupTitle",
			"cellLabel": "BhaBTW_cellLabel",
			"chevron": "BhaBTW_chevron",
			"trigger": "BhaBTW_trigger",
			"empty": "BhaBTW_empty"
		};
		//#endregion
