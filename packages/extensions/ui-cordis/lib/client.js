window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = ".D_ncva_card{flex-direction:column;gap:8px;display:flex}.D_ncva_row{align-items:center;min-height:32px;display:flex}.D_ncva_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.D_ncva_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.D_ncva_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.D_ncva_summary,.D_ncva_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.D_ncva_error{color:var(--dsw-alias-state-error-primary)}.D_ncva_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.D_ncva_card[data-cordis-status=awaiting-approval] .D_ncva_status,.D_ncva_card[data-cordis-status=client-pending] .D_ncva_status{color:var(--dsw-alias-state-warn-label)}.D_ncva_card[data-cordis-status=running] .D_ncva_status{color:var(--dsw-alias-state-success-primary)}.D_ncva_card[data-cordis-status=failed] .D_ncva_status{color:var(--dsw-alias-state-error-primary)}.D_ncva_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.D_ncva_card:hover .D_ncva_inspect,.D_ncva_inspect:focus-visible{opacity:1}.D_ncva_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.D_ncva_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.D_ncva_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.D_ncva_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.D_ncva_business .D_ncva_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"output": "D_ncva_output",
			"icon": "D_ncva_icon",
			"card": "D_ncva_card",
			"row": "D_ncva_row",
			"summary": "D_ncva_summary",
			"business": "D_ncva_business",
			"title": "D_ncva_title",
			"error": "D_ncva_error",
			"inspect": "D_ncva_inspect",
			"message": "D_ncva_message",
			"status": "D_ncva_status",
			"separator": "D_ncva_separator"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".B1XO_G_card{flex-direction:column;display:flex}.B1XO_G_card .B1XO_G_title,.B1XO_G_card .B1XO_G_chevron{color:var(--dsw-alias-state-business-primary)}.B1XO_G_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.B1XO_G_row{gap:0}.B1XO_G_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.B1XO_G_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.B1XO_G_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.B1XO_G_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.B1XO_G_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.B1XO_G_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.B1XO_G_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.B1XO_G_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.B1XO_G_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.B1XO_G_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.B1XO_G_switch{height:22px;padding:0 8px;font-size:12px}.B1XO_G_card[data-terminal] .B1XO_G_title,.B1XO_G_card[data-terminal] .B1XO_G_name,.B1XO_G_card[data-terminal] .B1XO_G_purpose,.B1XO_G_card[data-terminal] .B1XO_G_statusLabel{color:var(--dsw-alias-label-caption)}.B1XO_G_card[data-terminal] .B1XO_G_separator{background:var(--dsw-alias-label-caption)}.B1XO_G_bodyWrap{flex-direction:column;display:flex}.B1XO_G_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.B1XO_G_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.B1XO_G_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.B1XO_G_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.B1XO_G_sourceTab:disabled{cursor:default;opacity:.4}.B1XO_G_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.B1XO_G_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.B1XO_G_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.B1XO_G_sourcePanel{max-height:260px;overflow:auto}.B1XO_G_sourceCode{margin:0}.B1XO_G_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.B1XO_G_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.B1XO_G_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.B1XO_G_output[data-error]{color:var(--dsw-alias-state-error-primary)}.B1XO_G_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.B1XO_G_card:hover .B1XO_G_inspectButton,.B1XO_G_inspectButton:focus-visible{opacity:1}.B1XO_G_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.B1XO_G_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.B1XO_G_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"inspectButton": "B1XO_G_inspectButton",
			"readout": "B1XO_G_readout",
			"statusLabel": "B1XO_G_statusLabel",
			"chevron": "B1XO_G_chevron",
			"name": "B1XO_G_name",
			"errorSummary": "B1XO_G_errorSummary",
			"requestError": "B1XO_G_requestError",
			"approvalPrompt": "B1XO_G_approvalPrompt",
			"purpose": "B1XO_G_purpose",
			"row": "B1XO_G_row",
			"notice": "B1XO_G_notice",
			"bodyWrap": "B1XO_G_bodyWrap",
			"sourceCard": "B1XO_G_sourceCard",
			"sourceTab": "B1XO_G_sourceTab",
			"sourcePanel": "B1XO_G_sourcePanel",
			"sourceCode": "B1XO_G_sourceCode",
			"visuallyHidden": "B1XO_G_visuallyHidden",
			"panelHint": "B1XO_G_panelHint",
			"codeSection": "B1XO_G_codeSection",
			"sourceTabActive": "B1XO_G_sourceTabActive",
			"sectionLabel": "B1XO_G_sectionLabel",
			"card": "B1XO_G_card",
			"separator": "B1XO_G_separator",
			"sourceTabs": "B1XO_G_sourceTabs",
			"title": "B1XO_G_title",
			"switch": "B1XO_G_switch",
			"output": "B1XO_G_output"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/yfjz/workspace/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".yzyriG_layer{flex:none;align-items:center;width:100%;height:49px;margin:8px 0 0;display:flex;position:relative}.yzyriG_footerButtons{align-items:center;width:100%;display:flex}.yzyriG_badge{width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.yzyriG_badge:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.yzyriG_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.yzyriG_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.yzyriG_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.yzyriG_layer.yzyriG_rail{width:36px;height:36px;margin:0}.yzyriG_rail .yzyriG_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.yzyriG_rail .yzyriG_footerButtons{flex-direction:column;gap:2px}.yzyriG_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;bottom:128px;left:12px;overflow:hidden}.yzyriG_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.yzyriG_body{flex:1;min-height:0;padding:4px 12px 12px;overflow-y:auto}.yzyriG_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:20px}.yzyriG_note,.yzyriG_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.yzyriG_readError{color:var(--dsw-alias-state-error-primary)}.yzyriG_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0 4px;font-size:11px;font-weight:500;line-height:16px}.yzyriG_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.yzyriG_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.yzyriG_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.yzyriG_rowHead{align-items:center;gap:8px;display:flex}.yzyriG_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.yzyriG_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.yzyriG_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.yzyriG_row[data-cordis-status=idle] .yzyriG_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.yzyriG_row[data-cordis-status=awaiting-approval] .yzyriG_rowStatus,.yzyriG_row[data-cordis-status=client-pending] .yzyriG_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.yzyriG_row[data-cordis-status=failed] .yzyriG_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.yzyriG_row[data-cordis-status=running] .yzyriG_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.yzyriG_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.yzyriG_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.yzyriG_versionPicker select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;border-radius:7px;flex:1;padding:0 8px}.yzyriG_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.yzyriG_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.yzyriG_rowActions{flex:none;align-items:center;gap:10px;display:flex}.yzyriG_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.yzyriG_transitionActions{gap:6px;margin-left:auto;display:flex}.yzyriG_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.yzyriG_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.yzyriG_transitionActions button:disabled{opacity:.4;cursor:default}.yzyriG_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.yzyriG_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.yzyriG_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.yzyriG_actionButton:disabled{opacity:.4;cursor:default}.yzyriG_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.yzyriG_doubleCheck svg{position:absolute;top:1px}.yzyriG_doubleCheck svg:first-child{opacity:.7;left:0}.yzyriG_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"activeVersion": "yzyriG_activeVersion",
			"panel": "yzyriG_panel",
			"rowActions": "yzyriG_rowActions",
			"badgeCount": "yzyriG_badgeCount",
			"actionButton": "yzyriG_actionButton",
			"rowDetail": "yzyriG_rowDetail",
			"transitionActions": "yzyriG_transitionActions",
			"rowStatus": "yzyriG_rowStatus",
			"body": "yzyriG_body",
			"footerButtons": "yzyriG_footerButtons",
			"rows": "yzyriG_rows",
			"transition": "yzyriG_transition",
			"versionPicker": "yzyriG_versionPicker",
			"row": "yzyriG_row",
			"readError": "yzyriG_readError",
			"rail": "yzyriG_rail",
			"rowId": "yzyriG_rowId",
			"rowError": "yzyriG_rowError",
			"badge": "yzyriG_badge",
			"badgeLabel": "yzyriG_badgeLabel",
			"rowPurpose": "yzyriG_rowPurpose",
			"rowName": "yzyriG_rowName",
			"layer": "yzyriG_layer",
			"group": "yzyriG_group",
			"header": "yzyriG_header",
			"rowHead": "yzyriG_rowHead",
			"note": "yzyriG_note",
			"doubleCheck": "yzyriG_doubleCheck",
			"title": "yzyriG_title"
		};
		//#endregion
